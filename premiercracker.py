...
path_to_current_file = r"C:\Program Files\Adobe\Adobe Premiere Pro CC 2018\AMT\application.xml"
path_to_temp_new_destination = getenv("TEMP") + r"\application.xml"
path_to_new_destination = r"C:\Program Files\Adobe\Adobe Premiere Pro CC 2018\AMT\application.xml"
...
class Cracker():
    ...
    def crackit(cls):
        ...
        file = file[:1228] + numberstr + file[1233:]
