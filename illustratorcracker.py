...
path_to_current_file = r"C:\Program Files\Adobe\Adobe Illustrator CC 2018\Support Files\Contents\Windows\AMT\application.xml"
path_to_temp_new_destination = getenv("TEMP") + r"\application.xml"
path_to_new_destination = r"C:\Program Files\Adobe\Adobe Illustrator CC 2018\Support Files\Contents\Windows\AMT\application.xml"
...
class Cracker():
    ...
    def crackit(cls):
        ...
        file = file[:1371] + numberstr + file[1376:]
